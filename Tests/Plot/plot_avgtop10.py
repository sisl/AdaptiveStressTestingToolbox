...
# plot_name = "GA_kl"
plolicies = ["GAInter","GAInterStep0.1Anneal1.0","GAInterStep0.5Anneal1.0","GAInterStep1.0Anneal1.0",\
                "GATRInter","GATRInter_kl01","GATRInterstep0.5anneal1.0","GATRInterStep1.0Anneal1.0"]
plot_name = "GA_step"
