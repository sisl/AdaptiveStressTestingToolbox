...
class LunarLander(gym.Env,Serializable):
    metadata = {
    ...
    def __init__(self,
                ...
                initial_force_right=1.5,#1,#2,#3,#5,#0,#10,#50,#100,#300,#500,#1000,
                initial_force_up=-0,#500,#1000,
                ):
    ...
    def step(self, action):
        ...
        dispersion = [self.np_random.uniform(-1.0, +1.0)*self.dispersion_max / SCALE for _ in range(2)]
