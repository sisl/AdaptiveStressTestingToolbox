...
class CartPoleEnv(gym.Env,Serializable):
    ...
    def __init__(self,
                ...
                initial_condition_bias = 0.2,#0.1,#0.16#0.12,#0.2,#0.02,
                theta_threshold_radians = 11 * 2 * math.pi / 360,#4#5#5.5#6#7#8#10#12
                x_threshold = 2.2,#2.0,#1.2,#1.0#0.8#1.2#1.4#1.6#2.4
