...
from ast_toolbox.rewards.crazy_trolley_reward import CrazyTrolleyReward
from ast_toolbox.samplers import ASTVectorizedSampler
from ast_toolbox.simulators.crazy_trolley.crazy_trolley_ast import CrazyTrolleyASTSimulator
from ast_toolbox.spaces.crazy_trolley_spaces import CrazyTrolleySpaces
        ...
        with tf.Session(config=config) as sess:
            with tf.variable_scope('AST', reuse=tf.AUTO_REUSE):
                ...
                with LocalTFRunner(
                    ...
                    sim = CrazyTrolleyASTSimulator(**sim_args)
                    reward_function = CrazyTrolleyReward(**reward_args)
                    spaces = CrazyTrolleySpaces(**spaces_args)
