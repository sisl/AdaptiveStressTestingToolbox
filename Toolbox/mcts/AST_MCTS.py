...
def rollout_getAction(ast):
    ...
    Parameters
    ----------
    ast : :py:class:`mcts.AdaptiveStressTest.AdaptiveStressTesting`
        The AST object.
    """
...
def stress_test(ast, mcts_params, top_paths, verbose=True, return_tree=False):
    ...
    ast : :py:class:`mcts.AdaptiveStressTest.AdaptiveStressTesting`
        The AST object.
    mcts_params: :py:class:`mcts.MCTSdpw.DPWParams`
        The mcts parameters.
    top_paths : :py:class:`mcts.BoundedPriorityQueues`
    ...
    Returns
    -------
    results : :py:class:`mcts.AdaptiveStressTest.AdaptiveStressTesting`
        The bounded priority queue storing top-rewarded trajectories.
    tree : dict
        The resulting searching tree.
    """
    mcts_params.n = int(mcts_params.n/ast.params.max_steps)
