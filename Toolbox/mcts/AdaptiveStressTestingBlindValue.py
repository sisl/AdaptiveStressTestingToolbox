...
from mcts.AdaptiveStressTesting import ASTAction
...
class AdaptiveStressTestBV(AdaptiveStressTest):
    ...
    ----------
    kwargs :
        Keyword arguments passed to `mcts.AdaptiveStressTesting.AdaptiveStressTest`
    ...
    def getBV(self, y, rho, A, UCB):
        ...
        A : list[:py:class:`mcts.AdaptiveStressTesting.ASTAction`]
